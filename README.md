...
Use consistent coding, without too much code and just the necessary.
Use better naming in coding processes.
Be patient on thinking the best way of the algorithm needed.
Keep in mind that code has to keep tests to work consistently
